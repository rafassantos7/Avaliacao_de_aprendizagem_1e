...
def test_salario_tipo_invalido_retorna_mensagem_excessao():
    with pytest.raises(TypeError, match= "O salário deve ser em float."):
        Engenheiro(1234,"Luis Sérgio","21286428","luisinhorj@hotmail.com",
                         Endereco("Rua dos RJotinha","123","ap 02","4123500","Petropolis",UnidadeFederativa.RIO_DE_JANEIRO)
                         ,Sexo.MASCULINO,EstadoCivil.DIVORCIADO,"08/06/1974","657124500","1642631","3845323846"
                         ,Setor.ENGENHARIA, "20000" ,"12345")

def test_crea_invalido_retorna_mensagem_excessao():
    with pytest.raises(TypeError, match= "O CREA não pode ser vazio."):
        Engenheiro(123,"Luis Sérgio","21286428","luisinhorj@hotmail.com",
                         Endereco("Rua dos RJotinha","123","ap 02","4123500","Petropolis",UnidadeFederativa.RIO_DE_JANEIRO)
                         ,Sexo.MASCULINO,EstadoCivil.DIVORCIADO,"08/06/1974","657124500","1642631","3845323846"
                         ,Setor.ENGENHARIA,20.000,"")

def test_email_invalido_retorna_mensagem_excessao():
    with pytest.raises(ValueError,match = "O email deve conter @."):
        Engenheiro(123,"Luis Sérgio","21286428","luisinhorjhotmail.com",
                         Endereco("Rua dos RJotinha","123","ap 02","4123500","Petropolis",UnidadeFederativa.RIO_DE_JANEIRO)
                         ,Sexo.MASCULINO,EstadoCivil.DIVORCIADO,"08/06/1974","657124500","1642631","3845323846"
                         ,Setor.ENGENHARIA,20.000,"")