...
def test_crm_invalido_retorna_mensagem_excessao():
    with pytest.raises(TypeError, match= "O CRM não pode ser vazio"):
        Medico(777,"pedro","7187984-9876","pedro000@gmail.com",
                  Endereco("Rua dos brasileiros","102","Proximo a rua dos paraguaios","4100000","São Paulo",UnidadeFederativa.SAO_PAULO),
                  Sexo.MASCULINO,EstadoCivil.DIVORCIADO,"01/03/1975","48721598745",
                  "484321-897","8795464",Setor.SAUDE,10000.01,"")

def test_email_invalido_retorna_mensagem_excessao():
    with pytest.raises(ValueError,match = "O email deve conter @."):
        Medico(777,"Pedro","7187984-9876","pedro000gmail.com",
                  Endereco("Rua dos brasileiros","102","Proximo a rua dos paraguaios","4100000","São Paulo",UnidadeFederativa.SAO_PAULO),
                  Sexo.MASCULINO,EstadoCivil.DIVORCIADO,"01/03/1975","48721598745","484321-897","8795464",Setor.SAUDE,10000.01,"654654")
